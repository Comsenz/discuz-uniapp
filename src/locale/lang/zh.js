...
export default {
  discuzq: {
    ...
    post: {
      ...
      // 投票帖
      pleaseEnterVotingTitle: '请输入投票标题',
      options: '选项',
      writeVotingOptions: '填写投票选项',
      addVotingOptions: '增加一项',
      VotingContent: '投票帖的内容..',
      maximumSelect: '最多可选',
      enterMaximumSelect: '输入最多可选项',
      enterCountingDays: '输入计票天数',
      optionsNum: '{num} 项',
      countingDays: '计票天数',
      daysNum: '{num} 天',
      theResultsAreVisibleAfterTheVote: '投票后结果可见',
      publicVotingParticipants: '公开投票参与人',
  ...
  topic: {
    ...
    multipleVote: '多选投票',
    youHaveVoted: '您已投票',
    votersTotal: '共有 {total} 人参与投票',
    theVotingIsOver: '本次投票已结束',
