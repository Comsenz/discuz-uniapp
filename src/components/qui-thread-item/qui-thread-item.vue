<template>
  <view class="thread">
    <qui-content
      ...
      :post-goods="thread.firstPost && thread.firstPost.postGoods ? thread.firstPost.postGoods : ''"
      ...
      :theme-content="
        thread.type == 1 || thread.type == 7 ? thread.title : thread.firstPost.summary
      "
      :thread-type="thread.type"
      :them-pay-btn="thread.price > 0 || thread.attachmentPrice > 0"
      :media-url="thread.threadVideo && thread.threadVideo.media_url"
      :is-great="thread.firstPost ? thread.firstPost.isLiked : false"
      :theme-like="thread.firstPost ? thread.firstPost.likeCount : 0"
      :theme-comment="thread.postCount - 1"
      :tags="[thread.category]"
      :images-list="thread.firstPost ? thread.firstPost.images : []"
