  ...
  <qui-page :data-qui-theme="theme" class="withdrawalslist">
    <view class="withdrawalslist-head">
      ...
      <picker mode="date" :value="date" @change="bindDateChange" fields="month" class="date-picker">
        <view class="uni-input">{{ `${date}${i18n.t('questions.answers')}` }}</view>
      </picker>
    </view>
    <scroll-view
      scroll-y="true"
    ...
    >
      <view class="withdrawalslist-items">
        <qui-content :theme-type="themeType"></qui-content>
      </view>
...
export default {
  data() {
    return {
      ...
      show: false,
      date: '3',
      filterSelected: { label: this.i18n.t('questions.allTypes'), value: '' }, // 筛选类型
      operateStatus: [
